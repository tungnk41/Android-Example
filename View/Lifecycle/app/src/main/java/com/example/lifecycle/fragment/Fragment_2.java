...
public class Fragment_2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        startFragment3 = view.findViewById(R.id.btnStartFragment3);
        startFragment3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Utils.getInstance().navigate(getFragmentManager(),R.id.fragment_holder,new Fragment_3());
            }
        });
